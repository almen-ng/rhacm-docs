...
Continue reading to understand what metrics can be collected with the observability component, and for information about the observability pod capacity.
